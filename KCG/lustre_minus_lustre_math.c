...
#include "lustre_minus_lustre_math.h"

/* lustre_math::lustre_minus/ */
void lustre_minus_lustre_math(
...
void lustre_minus_init_lustre_math(outC_lustre_minus_lustre_math *outC)
{
...
void lustre_minus_reset_lustre_math(outC_lustre_minus_lustre_math *outC)
{
}
